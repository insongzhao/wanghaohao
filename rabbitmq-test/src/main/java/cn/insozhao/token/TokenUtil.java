...
public class TokenUtil {
     ...
     * 签名秘钥,可以换成 秘钥 注入
     */
    public static final String SECRET = "whh1234";//注意:本参数需要长一点，不然后面剪切的时候很可能长度为0，就会报错
    /**
     * 签发地
     */
    public static final String issuer  = "insozhao.cn";
    /**
     * 过期时间 三天
     */
    public static final long ttlMillis = 3600*1000*72;
